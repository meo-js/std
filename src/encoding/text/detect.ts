 ...
 */
export function detect(bytes: AnyBufferSource): Encoding {
 ...
 */
export function analyse(bytes: AnyBufferSource): AnalyseResult {
 ...
 */
export function isAscii(bytes: AnyBufferSource): boolean {
 ...
 */
export function isBig5(bytes: AnyBufferSource): boolean {
 ...
 */
export function isEuc_JP(bytes: AnyBufferSource): boolean {
 ...
 */
export function isEuc_KR(bytes: AnyBufferSource): boolean {
 ...
 */
export function isGb18030(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso2022(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso2022_CN(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso2022_JP(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso2022_KR(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_1(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_2(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_5(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_6(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_7(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_8(bytes: AnyBufferSource): boolean {
 ...
 */
export function isIso8859_9(bytes: AnyBufferSource): boolean {
 ...
 */
export function isKoi8R(bytes: AnyBufferSource): boolean {
 ...
 */
export function isMbcs(bytes: AnyBufferSource): boolean {
 ...
 */
export function isSbcs(bytes: AnyBufferSource): boolean {
 ...
 */
export function isShift_JIS(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf16le(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf16be(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf16(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf32(bytes: AnyBufferSource): boolean {
  const encoding = detect(bytes);
 ...
 */
export function isUtf32be(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf32le(bytes: AnyBufferSource): boolean {
 ...
 */
export function isUtf8(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1250(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1251(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1252(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1253(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1254(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1255(bytes: AnyBufferSource): boolean {
 ...
 */
export function isWindows1256(bytes: AnyBufferSource): boolean {
